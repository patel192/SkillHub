...
const GradientHeading = ({ pre, accent, post, size = "lg", className = "" }) => {
  const sizes = {
...
const GlowCard = ({ children, className = "", accentColor = C.brand }) => (
  <div className={`relative group ${className}`}>
    <div
      ...
      style={{ background: `linear-gradient(135deg, ${accentColor}55, transparent 60%)` }}
    />
    <div
...
export const PublicLayout = () => {
  ...
  return (
    ...
    >
        ...
        <AnimatePresence>
          {menuOpen && (
            <motion.div
              ...
              style={{ background: `${C.surface}F5`, borderBottom: `1px solid ${C.border}` }}
            ...
            >
              <div className="px-5 py-6 space-y-4">
                ...
                <div className="pt-4 space-y-3 border-t" style={{ borderColor: C.border }}>
                  <Link
                    to="/login"
            ...
            >
              ...
              <motion.div variants={fadeUp}>
                <span
                  ...
                  style={{ background: `${C.brand}12`, borderColor: C.border, color: C.brand }}
                >
              ...
              >
                ...
                mentorship, ship production-grade projects, and land your dream job.
              </motion.p>
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  onMouseEnter={(e) => (e.currentTarget.style.boxShadow = `0 0 48px ${C.brand}66`)}
                  onMouseLeave={(e) => (e.currentTarget.style.boxShadow = `0 0 32px ${C.brand}44`)}
                >
                  Start Learning Free
              ...
              >
                {STATS.map((stat, idx) => (
                  <div key={idx} className="space-y-1">
                    <div className="text-2xl sm:text-3xl font-bold" style={{ color: C.text, fontFamily: "'Fraunces', serif" }}>
                      <AnimatedCounter value={stat.value} />
                    </div>
                    <div className="text-sm" style={{ color: C.textMuted }}>{stat.label}</div>
                  </div>
                ))}
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1 text-center text-xs font-mono" style={{ color: C.textDim }}>
                ...
                <div className="p-6 font-mono text-sm leading-7">
                  <div className="flex gap-5">
                    <div className="select-none text-right" style={{ color: C.textDim, minWidth: 16 }}>
                    ...
                    <div className="space-y-0 flex-1">
                      ...
                      <div style={{ color: C.textDim }}>{"// SkillHub — Live Dashboard"}</div>
                      <div>&nbsp;</div>
                      <div>
                        <span style={{ color: "#78B9C2" }}>export default function </span>
                ...
                <div className="px-6 pb-5">
                  <div className="flex justify-between text-[11px] mb-1.5" style={{ color: C.textMuted }}>
                    <span>Module 7 / 12</span><span>58% complete</span>
                  </div>
                  <div className="h-1 rounded-full" style={{ background: C.surface2 }}>
                    <motion.div
              ...
              >
                ...
                <div>
                  <p className="text-[12px] font-bold" style={{ color: C.text }}>Tests Passing</p>
                  <p className="text-[11px]" style={{ color: C.textMuted }}>24 / 24 completed</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <p className="text-[12px] font-bold" style={{ color: C.text }}>Mentor Online</p>
                  <p className="text-[11px]" style={{ color: C.textMuted }}>Available now</p>
                </div>
              </motion.div>
            </motion.div>
      ...
      <section id="features" className="py-24 lg:py-32 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 text-lg max-w-2xl mx-auto" style={{ color: C.textMuted }}>
              ...
              >
                <GlowCard accentColor={feature.accent}>
                  <div className="p-7 lg:p-8 h-full flex flex-col">
                    ...
                    <h3 className="text-xl font-bold mb-2" style={{ color: C.text, fontFamily: "'Fraunces', serif" }}>
                      {feature.title}
                    </h3>
                    <p className="flex-grow" style={{ color: C.textMuted }}>{feature.desc}</p>
                    ...
                    {feature.size === "large" && (
                      ...
                      >
                        <div className="flex items-center gap-2 text-sm mb-3" style={{ color: C.brand }}>
                          <Bot className="w-4 h-4" />
                          <span className="font-semibold">AI Learning Assistant</span>
                        </div>
                        {["Personalized curriculum", "Smart code reviews", "24/7 Q&A support"].map((item) => (
                          <div key={item} className="flex items-center gap-2 text-sm py-1" style={{ color: C.textMuted }}>
                            <CheckCircle2 className="w-4 h-4 flex-shrink-0" style={{ color: C.brand }} />
                            {item}
                          </div>
                        ))}
                      </div>
      ...
      >
        <p className="text-center text-xs font-bold uppercase tracking-[2px] mb-8" style={{ color: C.textDim }}>
          Learn the technologies that power the world's best products
        </p>

        <div className="relative">
          {/* Fade edges */}
          <div className="absolute left-0 top-0 bottom-0 w-32 z-10" style={{ background: `linear-gradient(to right, ${C.surface}CC, transparent)` }} />
          <div className="absolute right-0 top-0 bottom-0 w-32 z-10" style={{ background: `linear-gradient(to left, ${C.surface}CC, transparent)` }} />
          ...
          >
            {[...TECH_STACK, ...TECH_STACK].map((tech, idx) => (
              <div
                key={idx}
                className="flex items-center gap-3 px-5 py-3 rounded-full border whitespace-nowrap transition-colors"
                style={{ background: `${C.brand}08`, borderColor: C.border }}
              >
                <span className="text-xl">{tech.icon}</span>
                <span className="font-medium text-sm" style={{ color: C.textMuted }}>{tech.name}</span>
              </div>
            ))}
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-6">
            <div>
              ...
              <p className="mt-4 text-lg max-w-xl" style={{ color: C.textMuted }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {COURSES.map((course, idx) => (
              <motion.div
                ...
                style={{ background: C.surface, borderColor: C.border }}
                onMouseEnter={(e) => (e.currentTarget.style.borderColor = `${course.color}44`)}
              ...
              >
                ...
                <div className="aspect-video overflow-hidden relative">
                  ...
                  <div
                    className="absolute inset-0"
                    style={{ background: `linear-gradient(to top, ${C.surface} 0%, transparent 60%)` }}
                  />
                </div>
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-sm" style={{ color: C.textMuted }}>{course.duration}</span>
                  </div>

                  <h3
                    className="text-xl font-bold mb-2 transition-colors group-hover:text-[var(--c)]"
                    style={{ color: C.text, fontFamily: "'Fraunces', serif", "--c": course.color }}
                  >
                    {course.title}
                  </h3>

                  <div className="flex items-center gap-4 text-sm mb-4" style={{ color: C.textMuted }}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {course.tags.map((tag) => (
                      <span
                        ...
                        style={{ background: `${course.color}10`, color: course.color, borderColor: `${course.color}25` }}
                      >
                        {tag}
                      </span>
                    ))}
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <GradientHeading pre="Loved by" accent="developers" post="worldwide" />
          </motion.div>
            ...
            {TESTIMONIALS.map((t, idx) => (
              ...
              >
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-4 h-4" style={{ fill: C.accent, color: C.accent }} />
                  ))}
                </div>
                <p className="mb-6 leading-relaxed italic text-[15px]" style={{ color: C.textMuted }}>
                  "{t.content}"
                </p>
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden">
        <div
          ...
          style={{ background: `linear-gradient(to bottom, ${C.brand}08, transparent)` }}
        />
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg mb-10 max-w-xl mx-auto" style={{ color: "rgba(255,255,255,0.75)" }}>
                Join thousands of developers who have transformed their careers with SkillHub.
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center gap-6 text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
                {["No credit card required", "Free forever tier", "Cancel anytime"].map((t) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-14">
            ...
            <div className="col-span-2">
              ...
              <p className="text-sm max-w-xs mb-6 leading-relaxed" style={{ color: C.textMuted }}>
            ...
            {FOOTER_LINKS.map((section) => (
              <div key={section.title}>
                <h4 className="font-bold text-xs uppercase tracking-widest mb-5" style={{ color: C.text }}>
                  {section.title}
                </h4>
