    ...
    <div className="min-h-screen bg-gradient-to-b from-zinc-900 to-black text-white font-sans">
      ...
      <section className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-6 py-20 gap-10">
        ...
        >
          ...
          {/* Buttons with working navigation */}
          ...
          {[
            {
              ...
              text: "Master web development, design, and tech skills.",
              color: "text-cyan-400",
            },
            {
              icon: <BrainCircuit className="text-purple-400 w-7 h-7 mb-2" />,
              title: "Track Progress",
              text: "Visualize milestones and monitor completion.",
              color: "text-purple-400",
            },
            {
              icon: <UsersRound className="text-yellow-400 w-7 h-7 mb-2" />,
              title: "Peer Support",
              text: "Join communities, connect with mentors.",
              color: "text-yellow-400",
            },
            {
              icon: <BarChart3 className="text-pink-400 w-7 h-7 mb-2" />,
              title: "Real Results",
              text: "Build projects and gain certifications.",
              color: "text-pink-400",
            },
          ].map((feature, i) => (
            <motion.div
              ...
              className="bg-zinc-800/70 hover:bg-zinc-800/90 transition border border-zinc-700 rounded-xl p-5 shadow-lg group"
            >
              {feature.icon}
              <h4
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto text-center space-y-6">
        ...
        >
          <span className="text-blue-400 font-semibold">SkillHub</span> is a modern
          learning platform built for students, professionals, and tech enthusiasts.
          It’s designed to make skill development interactive and measurable —
          offering personalized learning paths, visual progress tracking, and
          certifications that actually mean something.  
          <br />
          <br />
          Whether you’re improving your web development skills or exploring AI and
          backend systems, SkillHub adapts to your goals and growth pace.
        </motion.p>
      </section>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {[1, 2, 3].map((_, i) => (
            <motion.div
              ...
              className="bg-zinc-800/70 p-6 rounded-xl shadow-lg"
            >
              <Star className="text-yellow-400 w-6 h-6 mb-2" />
              <p className="text-gray-300 text-sm mb-4">
                “SkillHub helped me improve my skills and land a job!”
              </p>
        ...
        <div className="space-y-6">
          {[
            ...
            <motion.div
              ...
              className="bg-zinc-800/70 p-5 rounded-xl cursor-pointer hover:bg-zinc-800/90 transition"
            >
